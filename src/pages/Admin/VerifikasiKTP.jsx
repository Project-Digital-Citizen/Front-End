      ...
      <>
        <form action="">
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            ...
            <span className="w-full max-w-screen md:w-3/5">{data.NIK}</span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text">Nama</span>
            <span className="w-full max-w-screen md:w-3/5">{data.nama}</span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text">Tempat, tanggal lahir</span>
          ...
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            ...
            <span className="w-full max-w-screen md:w-3/5">{data.alamat}</span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
          ...
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text md:ml-12">Kel/Desa</span>
            <span className="w-full max-w-screen md:w-2/4 md:-">
              {data.kelurahanDesa}
            </span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text md:ml-12">Kecamatan</span>
            <span className="w-full max-w-screen md:w-2/4 md:-">
              {data.kecamatan}
            </span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            ...
            <span className="w-full max-w-screen md:w-3/5">{data.agama}</span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text">Status Perkawinan</span>
            <span className="w-full max-w-screen md:w-3/5">{data.status}</span>
          </div>
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
          ...
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text">Surat Pengantar RT</span>
          ...
          <div className="justify-between w-full pt-4 form-control md:flex md:flex-row md:items-center">
            <span className="font-black label-text">Surat Pengantar RW</span>
            <div className="flex w-full max-w-screen md:w-3/5">
